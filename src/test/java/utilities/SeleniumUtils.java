...
public class SeleniumUtils {
     ...
     *     and pronts its url
     *     @param driver - is used to open new app
     *     @param element - is used to open new tab
     */
    ...
    public static void switchToNewTab(WebDriver driver, WebElement element){
        ...
        System.out.println("Cirrently, the driver is on:  " + driver.getCurrentUrl());
    }
    ...
    public static void click(WebDriver driver, WebElement element){
      //  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
        FluentWait wait = new FluentWait(driver).
                ignoring(ElementClickInterceptedException.class).withTimeout(Duration.ofSeconds(30));
...
public static void clearAndSendKeys(WebDriver driver,WebElement element, String textToSend){
    ...
    action.keyDown(element, Keys.COMMAND).sendKeys("a");
    action.keyDown(element, Keys.COMMAND);
    action.keyDown(element, Keys.BACK_SPACE);
    action.keyDown(element, Keys.CLEAR);
